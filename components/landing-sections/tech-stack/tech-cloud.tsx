/**
 * @library Internal
 * @description 3D icon cloud visualization of tech stack using dynamic icon cloud component
 */
...
const DynamicIconCloud = dynamic(
  () => import("@/components/landing-sections/tech-stack/icon-cloud").then((mod) => mod.IconCloud),
  { ssr: false }
);
